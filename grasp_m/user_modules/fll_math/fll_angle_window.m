...
if isempty(h) %i.e. if no window exists.
    ...
    %Text
    uicontrol('units','normalized','Position',[0.09,0.65,0.09,0.2],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'HorizontalAlignment','right','Style','text',...
        'String','Spot 1','BackgroundColor', grasp_env.background_color, 'ForegroundColor', [1 1 1]);
    uicontrol('units','normalized','Position',[0.09,0.50,0.09,0.2],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'HorizontalAlignment','right','Style','text',...
        'String','Spot 2','BackgroundColor', grasp_env.background_color, 'ForegroundColor', [1 1 1]);
    uicontrol('units','normalized','Position',[0.002,0.38,0.18,0.2],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'HorizontalAlignment','right','Style','text',...
        'String','Beam Centre','BackgroundColor', grasp_env.background_color, 'ForegroundColor', [1 1 1]);
    uicontrol('units','normalized','Position',[0.001,0.2,0.18,0.2],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'HorizontalAlignment','right','Style','text',...
    ...
    uicontrol('units','normalized','Position',[0.36,0.83,0.1,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'HorizontalAlignment','right','Style','text',...
    ...
    uicontrol('units','normalized','Position',[0.42,0.295,0.1,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'HorizontalAlignment','right','Style','text',...
    ...
    uicontrol('units','normalized','Position',[0.22,0.50,0.13,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String','0','HorizontalAlignment','left','Tag','x0','Visible','on');
    uicontrol('units','normalized','Position',[0.56,0.50,0.13,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String','0','HorizontalAlignment','left','Tag','y0','Visible','on');
    uicontrol('units','normalized','Position',[0.22,0.30,0.13,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String','0','HorizontalAlignment','left','Tag','beta','Visible','on');
    uicontrol('units','normalized','Position',[0.22,0.18,0.13,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String','0','HorizontalAlignment','left','Tag','beta90','Visible','on');
    uicontrol('units','normalized','Position',[0.56,0.30,0.13,0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String','0','HorizontalAlignment','left','Tag','d_beta','Visible','on');
    uicontrol('units','normalized','Position',[0.27 0.07 0.45 0.08],'ToolTip','','FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','pushbutton',...
    ...
    uicontrol('units','normalized','Position',[0.88 0.515 0.1 0.08],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','pushbutton',...
