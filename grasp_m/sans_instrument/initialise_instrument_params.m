...
%         inst_params.att.ratio(1,1,18) = 7; %Att number
    ...
    case 'ILL_d11'
        ...
        inst_params.att.ratio(2,:,2) = [4, 327.54, 305.27, 290.51, 298.69, 323.54, 368.04, 407.00, 370.45, 369.03, 489.09, 494.36, 277.84];
        ...
        %Describe Detector(s)
        inst_params.detectors = 1;
        if strcmp(grasp_env.inst_option,'new_d11');
            inst_params.detector1.type = 'multiwire';
            inst_params.detector1.view_position = 'centre';
            inst_params.detector1.pixels = [128 128]; %Number of pixels, x,y
            inst_params.detector1.pixel_size = [7.5, 7.5]; %mm [x y]
    ...
    case 'ILL_d33'
        if strcmp(grasp_env.inst_option,'D33_Model_Data');
            ...
            inst_params.filename.lead_string = [];
            inst_params.filename.extension_string = [];
            inst_params.filename.data_loader = 'd33_model_data_read';
            ...
            inst_params.att.number = [0, 1, 2, 3];
            inst_params.att.ratio = [1, 112, 447, 1790];
            inst_params.att.type = [{'aperture'}, {'sieve'}, {'sieve'}, {'sieve'}];
            ...
            inst_params.detector2.pixels = [32,128]; %Number of pixels, x,y
            inst_params.detector2.pixel_size = [5,5]; %mm [x y]
            inst_params.detector2.nominal_beam_centre = [16.5, 64.5]; %[x y]
            ...
            inst_params.detector3.pixels = [32,128]; %Number of pixels, x,y
            inst_params.detector3.pixel_size = [5,5]; %mm [x y]
            inst_params.detector3.nominal_beam_centre = [16.5, 64.5]; %[x y]
            ...
            inst_params.detector4.pixels = [128,32]; %Number of pixels, x,y
            inst_params.detector4.pixel_size = [5,5]; %mm [x y]
            inst_params.detector4.nominal_beam_centre = [64.5, 16.5]; %[x y]
            ...
            inst_params.detector5.pixels = [128,32]; %Number of pixels, x,y
            inst_params.detector5.pixel_size = [5,5]; %mm [x y]
            inst_params.detector5.nominal_beam_centre = [64.5 16.5]; %[x y]
...
%             inst_params.detector4.pixels = [32,256]; %Number of pixels, x,y
%             inst_params.detector4.pixel_size = [5,2.5]; %mm [x y]
%             inst_params.detector4.nominal_beam_centre = [16.5,128.5]; %[x y]
%             inst_params.detector4.nominal_det_translation = [80, 0]; %mm [x y]
%             inst_params.detector4.dead_time = zeros(1,32);
%             inst_params.detector4.imask = ones(256,32);
%             %Front-Right
%             inst_params.detector5.type = 'tube';
%             inst_params.detector5.view_position = 'right';
%             inst_params.detector5.pixels = [32,256]; %Number of pixels, x,y
%             inst_params.detector5.pixel_size = [5,2.5]; %mm [x y]
%             inst_params.detector5.nominal_beam_centre = [16.5, 128.5]; %[x y]
%             inst_params.detector5.nominal_det_translation = [-80, 0]; %mm [x y]
%             inst_params.detector5.dead_time = zeros(1,32);
%             inst_params.detector5.imask = ones(256,32);
%             %Front-Top
%             inst_params.detector2.type = 'tube';
%             inst_params.detector2.view_position = 'top';
%             inst_params.detector2.pixels = [256,32]; %Number of pixels, x,y
%             inst_params.detector2.pixel_size = [2.5,5]; %mm [x y]
%             inst_params.detector2.nominal_beam_centre = [128.5, 16.5]; %[x y]
%             inst_params.detector2.nominal_det_translation = [0, -80]; %mm [x y]
%             inst_params.detector2.dead_time = zeros(32,1);
%             inst_params.detector2.imask = ones(32,256);
%             %Front-Bottom
%             inst_params.detector3.type = 'tube';
%             inst_params.detector3.view_position = 'bottom';
%             inst_params.detector3.pixels = [256,32]; %Number of pixels, x,y
%             inst_params.detector3.pixel_size = [2.5,5]; %mm [x y]
%             inst_params.detector3.nominal_beam_centre = [128.5 16.5]; %[x y]
%             inst_params.detector3.nominal_det_translation = [0, 80]; %mm [x y]
%             inst_params.detector3.dead_time = zeros(32,1);
%             inst_params.detector3.imask = ones(32,256);
    ...
    case 'NIST_ng3'
        ...
        inst_params.att.ratio(1,:) = [4  1 0.444784  0.207506  0.092412  0.0417722  0.0187129   0.00851048  0.00170757  0.000320057 6.27682e-05 1.40323e-05];
        inst_params.att.ratio(2,:) = [5  1 0.419     0.1848    0.07746   0.03302    0.01397     0.005984    0.001084    0.0001918   3.69e-05    8.51e-06];
        inst_params.att.ratio(3,:) = [6  1 0.3935    0.1629    0.06422   0.02567    0.01017     0.004104    0.0006469   0.0001025   1.908e-05   5.161e-0];
        inst_params.att.ratio(4,:) = [7  1 0.3682    0.1447    0.05379   0.02036    0.007591    0.002888    0.0004142   6.085e-05   1.196e-05   4.4e-06];
        inst_params.att.ratio(5,:) = [8  1 0.3492    0.1292    0.04512   0.01604    0.005668    0.002029    0.0002607   3.681e-05   8.738e-06   4.273e-06];
        inst_params.att.ratio(6,:) = [10 1 0.3132    0.1056    0.03321   0.01067    0.003377    0.001098    0.0001201   1.835e-05   6.996e-06   1.88799e-07];
        inst_params.att.ratio(7,:) = [12 1 0.2936    0.09263   0.02707   0.00812    0.002423    0.0007419   7.664e-05   6.74002e-06 6.2901e-07  5.87021e-08];
        inst_params.att.ratio(8,:) = [14 1 0.2767    0.08171   0.02237   0.006316   0.001771    0.0005141   4.06624e-05 3.25288e-06 2.60221e-07 2.08169e-08];
        inst_params.att.ratio(9,:) = [17 1 0.2477    0.06656   0.01643   0.00419    0.001064    0.000272833 1.77379e-05 1.15321e-06 7.49748e-08 4.8744e-09];
        inst_params.att.ratio(10,:) = [20 1 0.22404   0.0546552 0.0121969 0.00282411 0.000651257 0.000150624 7.30624e-06 3.98173e-07 2.08029e-08 1.08687e-09];
    ...
    case 'NIST_ng7'
        ...
        inst_params.att.ratio(1,:) = [4  1  0.448656 0.217193  0.098019  0.0426904  0.0194353  0.00971666  0.00207332  0.000397173 9.43625e-05 2.1607e-05];
        inst_params.att.ratio(2,:) = [5  1  0.4192   0.1898    0.07877   0.03302    0.01398    0.005979    0.001054    0.0001911   3.557e-05   7.521e-06];
        inst_params.att.ratio(3,:) = [6  1  0.3925   0.1682    0.06611   0.02617    0.01037    0.004136    0.0006462   0.0001044   1.833e-05   2.91221e-06];
        inst_params.att.ratio(4,:) = [7  1  0.3661   0.148     0.05429   0.02026    0.0075496  0.002848    0.0003957   5.844e-05   1.014e-05   1.45252e-06];
        inst_params.att.ratio(5,:) = [8  1  0.3458   0.1321    0.04548   0.0158     0.005542   0.001946    0.0002368   3.236e-05   6.153e-06   7.93451e-07];
        inst_params.att.ratio(6,:) = [10 1  0.3098   0.1076    0.03318   0.01052    0.003339   0.001079    0.0001111   1.471e-05   1.64816e-06 1.92309e-07];
        inst_params.att.ratio(7,:) = [12 1  0.2922   0.0957    0.02798   0.008327   0.002505   0.0007717   7.642e-05   6.88523e-06 6.42353e-07 5.99279e-08];
        inst_params.att.ratio(8,:) = [14 1  0.2738   0.08485   0.0234    0.006665   0.001936   0.000588    4.83076e-05 4.06541e-06 3.42132e-07 2.87928e-08];
        inst_params.att.ratio(9,:) = [17 1 0.2544   0.07479   0.02004   0.005745   0.001765   0.000487337 3.99401e-05 3.27333e-06 2.68269e-07 2.19862e-08];
        inst_params.att.ratio(10,:) = [20 1 0.251352 0.0735965 0.0202492 0.00524807 0.00165959 0.000447713 3.54814e-05 2.81838e-06 2.2182e-07  1.7559e-08];
    ...
    case 'HZB_V4'
        ...
        inst_params.vectors.array_counts = 127; inst_params.vector_names{127} = {'Total Array Counts'};
        inst_params.vectors.monitor = 5; inst_params.vector_names{5} = {'Monitor'};
        inst_params.vectors.monitor1 = 6; inst_params.vector_names{5} = {'Monitor'};
        inst_params.vectors.monitor2 = 5; inst_params.vector_names{6} = {'Monitor2'};
        inst_params.vectors.det_angle = [61]; inst_params.vector_names{61} = {'Dan'};
        inst_params.vectors.trs = 101; inst_params.vector_names{101} = {'Trs'};
        inst_params.vectors.sdi = 64; inst_params.vector_names{64} = {'Sdi'};
        inst_params.vectors.sht = 67; inst_params.vector_names{67} = {'Sht'};
...
%
%     case 'Julich_KWS2'
%         %***** Instrument: Jeulich KWS2 *****
%
%         col = [1 2 4 8 14 18 20];
%         att = [1 1 1];
%
%         flux_col(1,:) = [1, 1, 1];
%         flux_col(2,:) = [100, 1, 1];
%
%         detector_size = [128 128]; %Number of pixels, x,y
%         pixel_size = [5, 5]; %mm [x y]
%         wav_range = [4.5 38];
%         dead_time = 1*10^-6;
%
%         %Parameter position vectors
%         param_vectors.wav = 53;
%         param_vectors.deltawav = 54;
%         param_vectors.detcalc = 34;
%         param_vectors.det = 19;
%         param_vectors.det_angle = [];
%         param_vectors.att_type = 59;
%         param_vectors.att_status = 60;
%         param_vectors.numor = 128;
%         param_vectors.col = 58;
%         param_vectors.by = 16;
%         param_vectors.bx = 17;
%         param_vectors.temp = 31;
%         param_vectors.treg = 30;
%         param_vectors.tset = 29;
%         param_vectors.field = 82;
%         param_vectors.san = 65;
%         param_vectors.phi = 102;
%         param_vectors.chpos = 66;
%         param_vectors.counts = 4;
%         param_vectors.time = 3;
%         param_vectors.array_counts = 127;
%         param_vectors.monitor = 5;
%         param_vectors.moni1 = 5; %same as mon
%         param_vectors.moni2 = 6; %
%         param_vectors.moni3 = 7; %
%
%         inst_params = struct('att', att, 'col', col, 'det_size', detector_size,'fparams','empty', 'flux_col',flux_col,'pixel_size',pixel_size,'wav_range',wav_range,'dead_time',dead_time,'vectors',param_vectors);
%         %Finally add the instrument mask
%         imask = ones(detector_size(1),detector_size(2))*46;
%         inst_params.imask = imask;
%
