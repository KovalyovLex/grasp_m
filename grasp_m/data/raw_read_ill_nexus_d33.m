...
param(inst_params.vectors.det) = (hdf5read(fname,strcat(entryName,'/D33/detector/det2_actual'))); %m
try; param(inst_params.vectors.detcalc) = (hdf5read(fname,strcat(entryName,'/D33/detector/det2_calc'))); %m
catch; param(inst_params.vectors.detcalc) = param(inst_params.vectors.det); end
...
for det = 1:inst_params.detectors
    ...
    for n = 1:numor_data.n_frames
        ...
        elseif strcmp(numor_data.file_type,'tof');
            ...
            tof_dist = status_flags.nomalization.d33_total_tof_dist;
