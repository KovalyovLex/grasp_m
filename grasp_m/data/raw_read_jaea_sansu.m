function numor_data = raw_read_jaea_sansu(fname,numor)

%Usage:  numor_data = raw_read_jaea_sansu(fname);
...
det_x = data_column(1);
det_y = data_column(2);
numor_data.data1 = reshape(data_column(3:length(data_column)),det_x,det_y);
fclose(fid);
...
numor_data.params1(inst_params.vectors.time) = str2num(header_info{22});
numor_data.params1(inst_params.vectors.by) = str2num(header_info{13});
numor_data.params1(inst_params.vectors.bx) = str2num(header_info{14});
numor_data.params1(inst_params.vectors.det) = str2num(header_info{11})/1000;
numor_data.params1(inst_params.vectors.col) = -str2num(header_info{10});
numor_data.params1(inst_params.vectors.san) = str2num(header_info{18});
numor_data.params1(inst_params.vectors.phi) = str2num(header_info{21});
numor_data.params1(inst_params.vectors.array_counts) = str2num(header_info{24});
numor_data.params1(inst_params.vectors.numor) = str2num(header_info{2});
...
numor_data.params1(inst_params.vectors.wav) = wavelength;
numor_data.params1(inst_params.vectors.deltawav) = 0.1;
