...
switch to_do
    ...
    case 'rundex'
        ...
        %if strcmp(print_headers,'on');
            ...
            disp_string = ['Run     Title                   Det     Col     Wav     Time    Monitor Mon/s   DetSum    Det/s     '];
        ...
        for numor = numor1:skip:numor2
            ...
            if not(isempty(file_name_path))
                ...
                disp_string = [disp_string num2str(param(inst_params.vectors.monitor)/param(inst_params.vectors.time),'%6.1f') blanks(10-length(num2str(param(inst_params.vectors.monitor)/param(inst_params.vectors.time),'%6.1f')))]; %Det Rate
